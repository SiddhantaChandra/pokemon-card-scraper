    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-6 py-4">
          <h2 className="text-2xl font-bold text-white">Pokemon Card Scraper</h2>
          <p className="text-indigo-100 mt-1">Advanced web scraping with real-time progress tracking</p>
        </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            {canStart && (
              <button
                ...
                disabled={isStarting}
                className={`
                  inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-xl shadow-sm
      ...
      {!isRunning && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">Ready to Start</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-3xl font-bold text-gray-400">0</p>
              <p className="text-sm text-gray-500 mt-1">Cards to Scrape</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-gray-400">0</p>
              <p className="text-sm text-gray-500 mt-1">Pages to Process</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-gray-400">0%</p>
